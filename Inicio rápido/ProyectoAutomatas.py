...
#
#NOTA: LOS SIGUIENTES COMENTARIOS NO TIENEN TILDES PORQUE NO ME LAS ACEPTA PYTHON
...
#a partir del tiempo 0 predeterminadamente (se hizo asi porque al asignar el tiempo en el analisis sintactico
#estaba dando un problema demasiado molesto y desconocido que tenia que ver con los tokens que detectaban numeros)
#
